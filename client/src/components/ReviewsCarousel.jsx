  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-50 to-white">
      <div className="container-narrow">
        ...
        >
          {/* Main Review Card */}
          <div className="card-elevated p-8 md:p-12 text-center overflow-hidden">
            <div className="relative">
              {reviews.map((review, index) => (
                ...
                >
                  ...
                  {/* Review Text */}
                  <blockquote className="text-xl md:text-2xl text-slate-700 font-medium leading-relaxed mb-8 max-w-3xl mx-auto">
                    "{review.text}"
                  </blockquote>

                  {/* Author Info */}
                  <div className="flex items-center justify-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[color:var(--rose)] to-[color:var(--rose-dark)] flex items-center justify-center text-white font-semibold">
          ...
          <button
            onClick={prevReview}
            className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white border border-slate-200 shadow-lg flex items-center justify-center text-slate-600 hover:text-[color:var(--rose)] hover:border-[color:var(--rose)] transition-all duration-200 hover:shadow-xl group"
          ...
          <button
            onClick={nextReview}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white border border-slate-200 shadow-lg flex items-center justify-center text-slate-600 hover:text-[color:var(--rose)] hover:border-[color:var(--rose)] transition-all duration-200 hover:shadow-xl group"
