...
export default function Navbar() {
  ...
  const linkBase = "px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 relative";
  const active   = "text-slate-900 bg-white/80 backdrop-blur-sm shadow-sm border border-[color:var(--rose)]/20";
  const inactive = "text-slate-600 hover:text-slate-900 hover:bg-white/60 hover:backdrop-blur-sm";
    ...
    <header className="sticky top-0 z-50 nav-frosted">
      <div className="container-narrow">
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" className="fill-slate-600 group-hover:fill-slate-900 transition-colors duration-200">
              {open
        ...
        <div className="md:hidden nav-frosted border-t border-[color:var(--rose)]/20 mobile-menu animate-slide-down">
          <nav className="container-narrow py-4 space-y-2">
            <NavLink 
              ...
              className={({isActive}) => `block ${linkBase} ${isActive ? active : inactive}`}
            >
